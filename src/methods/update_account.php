...
class update_account implements MethodsInterface
{
    public $time;
    ...
    public function __construct($session_id, $countQuery)
    {
        ...
        $post_data = [
            ...
            'params'    => json_encode([
                'account_info' => [
                    ...
                    'cont2' => 'Address ' . time(). ', home №' . rand(1, 100),
                ],
            ]),
        ];
        ...
        curl_setopt_array($curl,
            [
                CURLOPT_URL            => Config::$param['api_url_' . Config::$param['VERSION']] . '/Account/update_account',
