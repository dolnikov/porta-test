...
class add_followme_number implements MethodsInterface
{
    public $time;
    ...
    public function __construct($session_id, $countQuery)
    {
        ...
        $post_data = [
            ...
            'params'    => json_encode([
                'number_info' => [
                    'i_account' => Config::$param['i_account'],
                    'timeout' => '30',
                    'name' => 'PortaTest_' . time(),
                    'active' => 'Y',
                    'period' => 'Always',
                    'period_description' => 'always',
                    'redirect_number' => '0000123456'
                ],
            ]),
        ];
        ...
        curl_setopt_array($curl,
            [
                CURLOPT_URL            => Config::$param['api_url_' . Config::$param['VERSION']] . '/Account/add_followme_number',
