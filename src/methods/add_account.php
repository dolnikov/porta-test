...
class add_account implements MethodsInterface
{
    public $time;
    ...
    public function __construct($session_id, $countQuery)
    {
        ...
        $post_data = [
            ...
            'params'    => json_encode([
                'account_info' => [
                    "i_customer"        => Config::$param['i_customer'],
                    'batch_name'        => 'PortaTest_' . $rand,
                    'follow_me_enabled' => 'N',
                    'blocked'           => 'N',
                    'id'                => 'PortaTest_' . time() . '_' . $rand,
                    'h323_password'     => "123456qwerty",
                    'i_product'         => "15629",
                    'billing_model'     => '1',
                    'activation_date'   => date("Y-m-d", time()),
                ],
            ]),
        ];
        ...
        curl_setopt_array($curl,
            [
                CURLOPT_URL            => Config::$param['api_url_' . Config::$param['VERSION']] . '/Account/add_account',
